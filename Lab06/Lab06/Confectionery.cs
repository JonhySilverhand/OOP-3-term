...
namespace Lab06
{
    ...
    {   
        ...
        public Candy(string name, int sugcost = 23, int weight = 15)
        {
            if (sugcost < 0 || sugcost > 50)
                throw new SugarCostExeption("Некорректное значенмя кол-ва сахара", "Candy", sugcost);
    ...
    public class BoxOfChocolates : Confectionery, IBuyConfectionery
    {
        ...
        {
            //if (sugcost < 0 || sugcost > 500)
            //    throw new SugarCostExeption("Некорректное значение кол-ва сахара", "BoxOfChocolates", sugcost)
            Name = name;
            SugarCost = sugcost;
            Weight = weight;
        }
